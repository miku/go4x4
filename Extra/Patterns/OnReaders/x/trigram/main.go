...
var examples = map[string]string{
	"it": `La morfosintassi dell'italiano è conforme al modello delle altre lingue
...
`,
	"en": `Italian often was an official language of the various Italian states predating
...
`,
	"de": `Die wirkliche Vereinheitlichung, besonders der gesprochenen Sprache, erfolgte
